...
/**
 * Created by it's me on 8/16/2017.
 */
...
public class MarshMallowPermission {
    ...
    public static final int NETWORK_PERMISSION_REQUEST_CODE=5;
    public static final int WRITE_STORAGE_REQUEST_CODE=6;
    ...
    public void requestNetworkForCamera(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.ACCESS_NETWORK_STATE)){
            Toast.makeText(activity, "Network permission needed. Please allow in App Settings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
